...
def calc_energy_forces_stress_padded_simple_trainable(
    params,  # NEW: Dictionary with trainable parameters
    itypes,
    all_js,
    all_rijs,
    all_jtypes,
    ...
    """
    Trainable version of calc_energy_forces_stress_padded_simple
    
    Args:
        params: Dict with keys ['species', 'basis', 'radial'] containing trainable coefficients
        ... other args same as before
    """
    
    # Extract trainable parameters from dictionary
    species_coeffs = params['species']
    moment_coeffs = params['basis']  # Note: using 'basis' key to match training function
    radial_coeffs = params['radial']
    ...
    energies, forces, stress = calc_energy_forces_stress(
        ...
        min_dist,
        max_dist,
        species_coeffs,  # Use trainable parameters
        moment_coeffs,   # Use trainable parameters
        radial_coeffs,   # Use trainable parameters
        execution_order,
        scalar_contractions
    )
