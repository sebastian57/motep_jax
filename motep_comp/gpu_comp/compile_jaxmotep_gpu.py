...
from motep_original_files.jax_engine.jax_opt import calc_energy_forces_stress_optimized as jax_calc
...
SYSTEM_CONFIGS = [
    (1024, 200, "1k", "Small systems (up to 1K atoms)"),
    (4096, 200, "4k", "Medium systems (up to 4K atoms)"), 
    (16384, 200, "16k", "Large systems (up to 16K atoms)"),
