/* -*- c++ -*- ----------------------------------------------------------
   ...
   Direct JAX Implementation - No Python Module Overhead
------------------------------------------------------------------------- */
...
class PairJaxMTPDirect : public Pair {
 ...
 private:
  ...
  // REUSED: NumPy helper functions (same as before)
  ...
  // NEW: Memory view helpers (avoid copying)
